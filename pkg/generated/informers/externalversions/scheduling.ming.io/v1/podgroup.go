...
import (
	...
	v1 "github.com/leemingeer/podgroup-scheduler-framework/pkg/generated/listers/scheduling.ming.io/v1"
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulingmingiov1.PodGroup{}, f.defaultInformer)
}
