...
import (
	...
	v1 "github.com/leemingeer/podgroup-scheduler-framework/pkg/generated/listers/scheduling/v1"
...
func (f *podGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&schedulingv1.PodGroup{}, f.defaultInformer)
}
